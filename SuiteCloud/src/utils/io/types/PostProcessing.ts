import { EntityRecordTypeEnum, idPropertyEnum, PostRecordOptions, RecordTypeEnum } from "src/utils/api";
 ...
 * @property {function} [pruneFunc] - A function that takes a {@link PostRecordOptions} object and returns a modified version of it or `null` to remove the record from the results.
 */
 ...
 * @property {Array<string>} fieldIds - `Array<string>` - `fieldIds` to clone from the donor's {@link FieldDictionary}'s ({@link PostRecordOptions}`.fields` 
