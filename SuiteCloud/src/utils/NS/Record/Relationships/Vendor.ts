...
import { EmailPreferenceEnum, GlobalSubscriptionStatusEnum } from "../../Enums";
 ...
 * @property {string} entityid - Required on Add. Copied from company name or name if not provided.
 * @property {string} subsidiary - Select the subsidiary to associate with this vendor.
 * @property {boolean} isinactive - When you check this box, this vendor will no longer appear on a list unless you check the Show Inactives box at the bottom of the list page.
 */
export interface VendorBase {
    /** @description entityid Required on Add. Copied from company name or name if not provided*/
    entityid?: string;
 ...
 */
export interface VendorFull extends VendorBase {
    /** @description accountnumber Sets the account number for vendors to reference.*/
    accountnumber?: string;
    /** @description Alt. Email */
    altemail?: string;
    /** @description Alt. Phone - Phone numbers can be entered in the following formats: 999-999-9999, 1-999-999-9999, (999) 999-9999, 1(999) 999-9999 or 999-999-9999 ext 9999*/
    altphone?: string;
    /** @description Auto Clear this box to manually enter a name for this record. If you leave this box marked, NetSuite assigns a name or number for this record based on your settings at Setup > Company > Auto-Generated Numbers.*/
    autoname?: boolean;
...
export const VENDOR_MUTABLE_BOOLEAN_FIELDS = [
    'isinactive', 'giveaccess', 'emailtransactions', 'faxtransactions', 
    'is1099eligible', 'sendemail', 'printtransactions', 'billpay', 'requirepwdchange'
];
