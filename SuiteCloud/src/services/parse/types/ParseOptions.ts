/**
 * @file src/services/types/ParseOptions.ts
 */
...
/**
 * @typedefn **`FieldDictionaryParseOptions`** - use to generate a `FieldDictionary`
 * @keys `fieldId` `string`
 * @values 
...
/**
 * @typedefn **`SublistDictionaryParseOptions`** - use to generate a `SublistDictionary`
...
/**
 * @description
 * @keys an explicit value to override
 * @values can be: 
