...
import { NetSuiteCountryEnum } from "./Enums";
 ...
 * @property {NetSuiteCountryEnum} [country] - Country {@link NetSuiteCountryEnum} - the country to be used for the address.
 ...
 * @property {string} [state] - State -Enter your company's state or province the way it should appear on all forms except checks.
