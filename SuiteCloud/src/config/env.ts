...
import { AccountEnvironmentEnum, SuiteScriptEnvironment, ScriptDictionary } from 'src/utils/ns';
dotenv.config();
...
// export const DATA_DIR = `C:/Users/${USER}/.dev/benev-dev-all/NetSuite/data`;
